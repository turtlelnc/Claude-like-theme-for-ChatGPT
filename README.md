...
5. Select the repository folder containing `manifest.json` and `theme.css` .(You can download these two files manually on the code page, or you can jump to our [Github Release](https://github.com/turtlelnc/Claude-like-theme-for-ChatGPT/releases/latest))

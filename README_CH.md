...
3. 启用**开发者模式**。
4. 点击**加载已解压的扩展程序**。
5. 选择包含 `manifest.json` 文件 与 `theme.css` 文件 的仓库文件夹。（关于这两个文件的下载可以在代码页手动操作，也可以跳转到我们的 [Github Release](https://github.com/turtlelnc/Claude-like-theme-for-ChatGPT/releases/latest)
6. 刷新 `chatgpt.com` 页面。
